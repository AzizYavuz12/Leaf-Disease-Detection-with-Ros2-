...
class AIAnalyzerNode(Node):
    def _init_(self):
        super()._init_('ai_analyzer_node')
        self.subscription = self.create_subscription(Image, 'camera/image_raw', self.listener_callback, 10)
        self.ai_publisher = self.create_publisher(String, 'ai/detections', 10)
        self.bridge = CvBridge()
        
        # 1. DOSYA YOLLARI 
        leaf_model_path = '/home/Desktop/ros2v2/src/robotanik_vision/models/leafdetectionfinal.pt'
        disease_model_path = '/home/Desktop/ros2v2/src/robotanik_vision/models/yolo11s_leaf_disease.pt'
        risk_model_path = '/home/Desktop/ros2v2/src/robotanik_vision/models/linear_risk_model_v4_noisy.pkl'
